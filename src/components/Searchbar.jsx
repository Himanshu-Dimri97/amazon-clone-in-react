...
export default function Searchbar() {
    return (
        <div class="flex justify-center">
            ...
            <input name="input" className='bg-white border-[#e6e6e6] font-semibold text-md text-[#555] w-120 sm:w-40 md:w-80 xl:w-120 lg:w-60 my-1.5 p-2' placeholder="Search Amazon.in" />
